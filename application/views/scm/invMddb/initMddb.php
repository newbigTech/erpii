...
<div class="wrapper">
    ...
    <div class="con-header">
      <dl class="cf">
        ...
        <dd id="identifier" style="float:right; margin-right: 10px;">
          <label>单据编号：</label>
          <span id="number"><?php echo str_no('MDDB')?></span></dd>
      </dl>
    </div>
    <div class="grid-wrap">
      <table id="grid">
  ...
  <div id="initCombo" class="dn">
    ...
    <input type="text" class="textbox inStorageMD" name="storageMD" autocomplete="off">
  </div>
  <div id="storageBox" class="shadow target_box dn">
  </div>
</div>
<script src="<?php echo base_url()?>statics/js/dist/transfersMddb.js?ver=201510141132"></script>
</body>
</html> 
