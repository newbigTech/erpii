	...
	<div class="mod-toolbar-top cf">
	    <div class="left">
          ...
          <div id="assisting-category-select" class="ui-tab-select">
            <strong class="tit">组织机构管理</strong>
            <ul class="searchbox cf">
		        <li>
		          <input type="text"  style="width:300px;" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入名称查询">
...
<script src="<?php echo base_url()?>statics/js/dist/orgList.js?ver=20171217"></script>
