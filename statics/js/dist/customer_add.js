$(function () {
	$('.btn_add').on('click',function () {
        ...
        $('#num').val(id);
		var add = '<ul class="mod-form-rows base-form clearfix" id="ul_' + id + '" style="margin-bottom: 20px">\n' +
            '                        <li class="row-item">\n' +
            '                            <div class="label-wrap"><label for="plateNo">车牌:</label></div>\n' +
            '                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="plateNo" id="plateNo"></div>\n' +
            '                        </li>\n' +
            '                        <li class="row-item">\n' +
            ...
            '                            <div class="ctn-wrap"><input type="date" value="" class="ui-input" name="buytime" id="buytime"></div>\n' +
            '                        </li>\n' +
            '                        <li class="row-item">\n' +
            '                            <div class="label-wrap"><label for="hasCheck">年款:</label></div>\n' +
            '                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="hasCheck" id="hasCheck"></div>\n' +
            '                        </li>\n' +
            '                        <li class="row-item">\n' +
            '                            <div class="label-wrap"><label for="notCheck">车型:</label></div>\n' +
            '                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="notCheck" id="notCheck"></div>\n' +
            '                        </li>\n' +
